...
PHP_SERVICE=laravel-php-nginx-tcp-core
NGINX_SERVICE=laravel-nginx-tcp-core
NODE_SERVICE=laravel-node-nginx-tcp-core
QUEUE_SERVICE=laravel-queue-nginx-tcp-core
SCHEDULER_SERVICE=laravel-scheduler-nginx-tcp-core
...
info: ## Показать информацию о проекте
	...
	@echo "  • 9000 - TCP: связь Nginx <-> PHP-FPM"
